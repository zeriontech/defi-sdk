  ...
  it('should return correct balances', async () => {
    await adapterRegistry.methods['getBalances(address)'](testAddress)
      ...
      .then((result) => {
        ...
        assert.deepEqual(result[0].adapterBalances[0].balances[1].underlying[0].metadata, knc);
        assert.deepEqual(result[0].adapterBalances[0].balances[2].underlying[0].metadata, bat);
      });
  });
});
