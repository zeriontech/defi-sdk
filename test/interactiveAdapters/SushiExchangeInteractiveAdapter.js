...
const SUSHISWAP_ADAPTER = web3.eth.abi.encodeParameter(
  'bytes32',
  web3.utils.toHex('SushiSwap'),
).slice(0, -2);
...
const SUSHISWAP_EXCHANGE_ADAPTER = `${SUSHISWAP_ADAPTER}${EXCHANGE_ADAPTER}`;
...
const InteractiveAdapter = artifacts.require('./SushiExchangeInteractiveAdapter');
const WethAdapter = artifacts.require('./WethInteractiveAdapter');
const Core = artifacts.require('./Core');
const Router = artifacts.require('./Router');
const ERC20 = artifacts.require('./ERC20');

contract.only('SushiExchangeInteractiveAdapter', () => {
