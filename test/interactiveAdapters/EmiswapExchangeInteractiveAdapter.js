...
const EMISWAP_V2_ADAPTER = web3.eth.abi.encodeParameter(
  'bytes32',
...
const EMISWAP_EXCHANGE_ADAPTER = `${EMISWAP_V2_ADAPTER}${EXCHANGE_ADAPTER}`;
...
const InteractiveAdapter = artifacts.require('./EmiswapExchangeInteractiveAdapter');
const WethAdapter = artifacts.require('./WethInteractiveAdapter');
const Core = artifacts.require('./Core');
const Router = artifacts.require('./Router');
const ERC20 = artifacts.require('./ERC20');

contract('EmiswapExchangeInteractiveAdapter', () => {
