...
const InteractiveAdapter = artifacts.require('./UniswapV3ExchangeInteractiveAdapter');
const WethAdapter = artifacts.require('./WethInteractiveAdapter');
const Core = artifacts.require('./Core');
const Router = artifacts.require('./Router');
const ERC20 = artifacts.require('./ERC20');

contract.only('UniswapV3ExchangeInteractiveAdapter', () => {
        ...
        [
          [
            ...
            web3.eth.abi.encodeParameters(
              ['bytes', 'address'],
              ['0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc20001f46B175474E89094C44Da98b954EedeAC495271d0F', daiAddress],
            ),
          ],
        ],
        // inputs
