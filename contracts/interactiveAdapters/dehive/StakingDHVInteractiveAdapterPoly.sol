...
contract StakingDHVInteractiveAdapterPoly is InteractiveAdapter, StakingDHVAdapter {
        ...
        returns (address[] memory tokensToBeWithdrawn)
    {
        ...
        ERC20(tokenAmounts[0].token).safeApprove(address(0x88cFC1bc9aEb80f6C8f5d310d6C3761c2a646Df7), amount, "DHV");
        //require(ERC20(tokenAmounts[0].token).balanceOf(address(this)) > 0, "123");
        // solhint-disable-next-line no-empty-blocks
        try IStakingPools(address(0x88cFC1bc9aEb80f6C8f5d310d6C3761c2a646Df7)).depositFor(0, amount, userAddress) {} catch Error(string memory reason) {
            revert(reason);
        } catch {
