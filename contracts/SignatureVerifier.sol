...
contract SignatureVerifier {
    ...
    bytes32 public constant DOMAIN_SEPARATOR_TYPEHASH = keccak256(abi.encodePacked(
            "EIP712Domain(",
...
//        (r, s, v) = abi.decode(sig, (bytes32, bytes32, uint8));
        ...
        return ecrecover(hashApproval(approval), v, r, s);
    }
        ...
        returns (bytes32)
    {
        ...
        return keccak256(abi.encodePacked(bytes1(0x19), bytes1(0x01), domainSeparator, approvalHash));
    }
}
