...
| [Bzx](./contracts/adapters/bzx) | Decentralized margin trading & lending & borrowing protocol.| [Asset adapter](./contracts/adapters/bzx/BzxAssetAdapter.sol) <br> [Debt adapter](contracts/adapters/bzx/BzxDebtAdapter.sol) <br> ["Staking Adapter"](./contracts/adapters/bzx/BzxStakingAdapter.sol) | ["iToken Adapter"](./contracts/adapters/bzx/BzxTokenAdapter.sol) |
