...
| [DDEX • Lending](./contracts/adapters/ddexLending) | Decentralized margin trading | [Asset adapter](./contracts/adapters/ddexLending/DdexLendingAssetAdapter.sol) | — |
...
| [DDEX • Spot](./contracts/adapters/ddexSpot) | Decentralized margin trading | [Asset adapter](./contracts/adapters/ddexSpot/DdexSpotAssetAdapter.sol) | — |
...
| [mStable](./contracts/adapters/mstable) | mStable unifies stablecoins, lending and swapping into one standard. | [Asset adapter](./contracts/adapters/mstable/MstableAssetAdapter.sol) | ["Masset"](./contracts/adapters/mstable/MstableTokenAdapter.sol) |
